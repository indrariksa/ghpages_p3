...
export function MahasiswaForm({ initialValues = {}, onSubmit, isEditing = false, onCancel }) {
    ...
    const handleChange = (e) => {
        ...
        // Opsional: Hapus error untuk field yang sedang diubah saat pengguna mulai mengetik
        // Ini memberikan umpan balik instan saat pengguna memperbaiki input
        if (errors[name]) {
            setErrors((prev) => {
    ...
    const validate = () => {
        ...
        if (!formData.npm) {
            ...
            newErrors.npm = "NPM harus berupa angka positif";
        }
